...
constructor(){
 ...
 if(quizz__questions){
     ...
     this.questionSelection = quizz__questions.questions[this.questionIndex];
 ...
 //a função vai executar assicrona//
 async nexStep(){
  ...
  if ( this.questionMaxIndex > this.questionIndex) {
    ...
    this.finished = true;
    this.answersSelected = quizz__questions.results[finalAnswer as keyof typeof quizz__questions.results]
  }
